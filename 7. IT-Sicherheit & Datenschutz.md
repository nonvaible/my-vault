...
- **Pharming:** Pharming basiert auf der Manipulation der DNS-Anfragen (DNS ist der Dienst, der die Namensauflösung in IP-basierten Netzwerken durchführt) von Webbrowsern. Damit werden die Benutzer auf gefälschte Webseitz
- **Spoofing:**
- **Nicknapping:**
